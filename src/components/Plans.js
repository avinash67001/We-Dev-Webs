    ...
    <div className="pt-5 bg-white" id="pricing">
      <div className="mx-auto pb-20 mt-4 max-w-7xl px-6 lg:px-8">
        ...
        <div className="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          ...
          {/* First Product */}
          <div className="ring-2 ring-indigo-500 rounded-3xl p-8 xl:p-10 "style={{ backgroundColor: "rgb(32 29 38)" }}>
            ...
            >
              <listitem className="flex gap-x-3 text-white">
                <svg
          ...
          {/* Second Product */}
          <div
            className="ring-2 ring-indigo-500 rounded-3xl p-8 xl:p-10 "
            style={{ backgroundColor: "#18161D" }}
          >
...
-lg font-semibold leading-8 text-white"
              >
                Product Type 2
              </h2>
          ...
          <div className="ring-2 ring-indigo-500 rounded-3xl p-8 xl:p-10 "style={{ backgroundColor: "rgb(32 29 38)" }}>
            ...
            <p className="mt-4 text-sm leading-6 text-white">
              The most popular choice. Product details for Product Type 3
            </p>
            <p className="mt-6 flex items-baseline gap-x-1">
              <span
                className="text-4xl font-bold tracking-tight text-white"
